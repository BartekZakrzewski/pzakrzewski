...
const Page = () => {
    return (
        <div className={`z-0`}>
            <main className={`w-full bg-[url('https://images.unsplash.com/photo-1627556704283-452301a45fd0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] aspect-[4/3] md:aspect-video lg:aspect-[300/100] bg-cover bg-center grid place-content-center `}>
