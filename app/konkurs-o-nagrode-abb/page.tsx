...
const Page = () => {
    return (
        <div className={`z-0`}>
            <main className={`w-full bg-[url('https://images.unsplash.com/photo-1636291764961-8087583150cc?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] gap-7 h-screen bg-cover bg-center grid place-content-center `}>
